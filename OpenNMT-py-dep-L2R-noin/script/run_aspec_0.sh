...
for i in {50..69}; do
    python ../train.py -data ../data/$DATA/run_stanford.pt -save_model "../result/$DATA/$TYPE/model$TYPE$i" \
        ...
        -label_smoothing 0.1 -valid_steps 450 -save_checkpoint_steps 450 --from_n_epoch 7 \
        -gpu 0 -report_every 500 -type $TYPE -val_path ../data/$DATA/val_stanford.pt -gold_path ~/$DATA/ASPEC-JE/dev/dev.en.atok.lower
