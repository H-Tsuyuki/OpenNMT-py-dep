...
def model_opts(parser):
    ...
    group.add('--no_add', '-no_add', action='store_true')
...
def train_opts(parser):
    ...
    group.add('--data', '-data', required=True,
              help='Path of data ')
    group.add('--breadth', '-breadth', action="store_true",
              help='Path of data ')
    ...
    group.add('--val_path', '-val_path', default='../data/multi30k/val_spacy.pt',
              help='Path of data ')
    group.add('--gold_path', '-gold_path', default='../../trans/data/multi30k/val.en.spacy_atok.lower',
              help='Path of data ')

    # GPU
    group.add('--gpu', '-gpu', type=int, default=3,
    ...
    group.add('--seed', '-seed', type=int, default=-1,
              help="Random seed used for the experiments "
                   "reproducibility.")
    group.add('--biaffine', '-biaffine', action='store_true', default=False)
    # Init options
    ...
    group.add('--n_epochs', '-n_epochs', type=int, default=0,
    ...
    group.add('--loss_type', '-type', default='base',
              choices=['base', 'p', 'c', 'pl', 'pc', 'lc', 'cl', 'plc', 'plcl', 'test'],
              help="loss type")
    group.add('--par_a', '-par_a', action="store_true", default=False)
    ...
    group.add('--from_n_epoch', '-from_n_epoch', type=int, default=4,
              help="Print stats at this interval.")
...
def translate_opts(parser):
    ...
    group.add('--batch_size', '-batch_size', type=int, default=30,
              help='Batch size')
    group.add('--gpu', '-gpu', type=int, default=None,
              help="Device to run on")
    group.add('--gpu_id', '-gpu_id', type=str, default=None,
              help="Device to run on")
