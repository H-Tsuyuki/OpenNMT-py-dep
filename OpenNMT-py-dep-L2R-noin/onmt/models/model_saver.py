...
def build_model_saver(model_opt, opt, model, data, optim):
...
class ModelSaverBase(object):
    ...
    * `_rm_checkpoint
    ...
    def __init__(self, base_path, model, model_opt, data, optim,
                 keep_checkpoint=-1):
...
class ModelSaver(ModelSaverBase):
    ...
    def _save(self, step, model):
        ...
        #logger.info("Saving %dth checkpoint %s.pt" % (step, self.base_path))
